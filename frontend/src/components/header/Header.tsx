...
const Header = () => {
  ...
  return (
    <>
      <div className="w-full h-16 flex  justify-between items-center px-4 border-2 border-slate-400 bg-white text-slate-900 dark:text-pulse-text dark:bg-pulse-surface2 dark:border-pulse-border ">
        <button
          type="button"
